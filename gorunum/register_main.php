            ...
            <div class="columns">
                ...
                <div class="column right has-text-centered">
                    ...
                    <form action="register.php" method="post">
                        <div class="field">
                            <div class="control">
                                <input class="input is-medium" type="text" name="rkadi" placeholder="username">
                            </div>
                        </div>

                        <div class="field">
                            <div class="control">
                                <input class="input is-medium" type="password" name="rsifre" placeholder="password">
                            </div>
                        </div>
                        <button type="submit" name="Tamamla" class="button is-block is-primary is-fullwidth is-medium">Submit</button>
                        <br />
